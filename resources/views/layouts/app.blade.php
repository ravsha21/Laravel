...
<head>
    ...
    <title>{{ config('app.name', 'Kidshop') }}</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            @foreach ($category as $cat)
                                <a class="dropdown-item" href="{{ url('/category') }}/{{ $cat->id }}">
                                {{$cat->name}}
                                </a>
                                @endforeach
                            </div>
                        </li>
	                    <li class="nav-item"><a href="{{ url('/home/#contact_us') }}" class="nav-link">About</a></li>
	                    <li class="nav-item"><a href="{{ url('/home/#contact_us') }}" class="nav-link">Contact</a></li>
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        ...
                        ?>
                        <li class="nav-item cta cta-colored"><a href="{{ url('cart/show') }}" class="nav-link"><span class="icon-shopping_cart"></span>[{{$cart}}]</a></li>
